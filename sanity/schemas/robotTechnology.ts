...
export default defineType({
  ...
  fields: [
    ...
    localizedStringArray('applications', 'Suitable applications', { group: 'taxonomy' }),
    localizedStringArray('selectionCriteria', 'Key selection criteria', { group: 'taxonomy' }),
    defineField({
  ...
  preview: {
    ...
    prepare({ title, subtitle, media }) {
      return { title: title || '(untitled technology)', subtitle, media }
    },
  },
  orderings: [
